...
class User
{
    ...
    public function __construct(array $data)
    {
        ...
        $this->created_at   = !is_null($data["deleted_at"]) ? DateTime::createFromFormat("Y-m-d H:i:s",$data["created_at"]) : null; 
        $this->updated_at   = !is_null($data["deleted_at"]) ? DateTime::createFromFormat("Y-m-d H:i:s",$data["updated_at"]) : null;
        $this->updated_at   = !is_null($data["deleted_at"]) ? DateTime::createFromFormat("Y-m-d H:i:s",$data["deleted_at"]) : null;
    }
